...
class VortexMath41App(_BASE_MODULE.VortexMathApp):
    ...
    def _build_learning_controls(self) -> None:
        ...
        text_box = {"facecolor": "none", "edgecolor": "none", "pad": 4.0}
        self.fig.text(0.04, 0.105, "Learning mode", fontsize=8, weight="bold", bbox=text_box)
        ...
        self.fig.text(0.20, 0.105, "Visual theme", fontsize=8, weight="bold", bbox=text_box)
        ...
        self.lesson_text = self.fig.text(
            0.37, 0.04, "", fontsize=8, color="0.3", va="bottom",
            bbox={"facecolor": "none", "edgecolor": "none", "pad": 4.0},
        )
